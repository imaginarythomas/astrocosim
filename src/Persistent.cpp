...
void MachineDestructible::save(TCODZip &zip) {
	zip.putInt(MACHINE);
	Destructible::save(zip);
}
...
void MachineAi::load(TCODZip &zip) {
    //TODO
}

void MachineAi::save(TCODZip &zip) {
    //TODO
}
...
void IdleNPCAi::load(TCODZip &zip) {

}

void IdleNPCAi::save(TCODZip &zip) {
...
void Engine::load() {
    ...
    engine.gui->menu.addItem(Menu::EXIT, "Quit");
...
void Sentient::save(TCODZip &zip){
    
    
}

void Sentient::load(TCODZip &zip){
